...
### Interactively [plot models in data space](tour.html)
...
---
## An example: Internet discussion forums ([20 Newsgroup data](https://ldavis.cpsievert.me/newsgroup/newsgroup.html))

<div align="center">
  <a href="LDAvis/#topic=4&lambda=1&term=">
...
### Helps to group techniques into categories based on data analysis tasks
]
...
### From _Interactive High-Dimensional Data Visualization_, [Buja et al 1996](https://www.jstor.org/stable/1390754)
...
.footnote[
### Over one where users have to write code?
]

??? 

The answer, of course, is that it depends, right?
