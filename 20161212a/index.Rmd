...
* [Cook, Buja, & Swayne 2007](https://www.jstor.org/stable/1390754) 
    * Focusing, arranging, and linking views enable comparisons, queries, and finding Gestalt.
...
* Many R packages allow you create  web graphics 
    ...
    * More common to see "specialized" graphics
...
* Most approaches neglect/ignore linking views and animation.
    * <b>ggvis</b> has some linking/animation, but requires a shiny server.
...
* <b>plotly</b> (Sievert el al. 2016) borrows ideas/foundations from <b>animint</b>.
    * Can also make <b>ggplot2</b> graphics interactive.
    * Also supports linking/animation.
    * Better support for focusing and arranging views. 
    * A "non-ggplot2" interface helps support visualizations not supported by ggplot2 (e.g., 3D charts).
    * More interaction types (mouse hover, click, click & drag).
    * Dynamic linked brush coloring (useful for making comparisons).
...
* Extensions for more popular <b>ggplot2</b> packages such as <b>ggrepel</b> <b>ggraph</b>.
