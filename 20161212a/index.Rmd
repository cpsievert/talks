...
## Interfacing R with web graphics libraries

* Many R packages allow you create interactive web graphics 
    * rCharts (), animint (), ggvis, rBokeh
    
* Most of these approaches neglect/ignore linking views.

* <b>plotly</b> builds on ideas and foundations laid in <b>animint</b>

## Diagnosing models

TODO: GGally example? Show implementation? Quote their paper?
