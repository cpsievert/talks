...
* Why interactive/dynamic graphics for <b>exploration</b>?
    ...
    * Better understand & diagnose statistical model fit(s) ([Wickham, Cook, & Hofmann 2015](http://onlinelibrary.wiley.com/doi/10.1002/sam.11271/abstract)).
...
## Querying via direct/indirect manipulation

<iframe src = "epl" style="border: 0; position:absolute; top:100; left:0; right:0; bottom:0; width:100%; height:85%"></iframe>

## Finding Gestalt with animation & highlighting
...
## The problem with web graphics for data analysis
...
* <b>My mission:</b> make web graphics practically useful for exploration.
    * A single programming interface should make 80% of what you want to do <b>easy</b> and the remaining 20% <b>possible</b>.
...
* Many R packages allow you create web graphics without HTML/JavaScript/CSS knowledge
...
* Further advance <b>plotly</b>'s support for linking views without <b>shiny</b>
    ...
    * Make other (worthwhile) packages aware of <b>plotly</b>'s linking features (there is already some initial support in [leaflet](https://vimeo.com/192710308) and [parcoords]())
