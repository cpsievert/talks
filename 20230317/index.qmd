...
venue: "ShinyConf2023 - R Shiny Conference by Appsilon"
type: "invited"
recording: "none"
format: 
  revealjs:
...
# Towards the next generation of Shiny UI {.title-slide background-image="main.webp" background-size="contain"}

Carson Sievert  
Software Engineer, Posit  
[bit.ly/bslib-dashboard-slides](https://bit.ly/bslib-dashboard-slides)

# Towards the next generation of Shiny UI {.title-slide .title-slide-strike background-image="main.webp" background-size="contain"}
