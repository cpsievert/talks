...
<img src="cranwhales.svg" width="85%" />
...
<div align="center">
  <img src="cranwhales-themed.png" width="73%" />
</div>
...
* Auto theming is "guaranteed" to work in a **shiny** runtime.

* Some other scenarios where it _can_ work:
  * A `rmarkdown::html_document()`.
  * In RStudio's plot viewer pane.
  * Auto value "defaults" are set via `auto_config_set()`
...
* Get **thematic** to play nicely with "complete" **ggplot2** themes (e.g., `theme_minimal()`, `ggthemes::theme_tufte()`, ).
...
* By default, `"auto"` colors are enabled...this generally works if:
  ...
  * Inside `rmarkdown::html_document()`.
  * Inside RStudio.
...
* Provide values directly to `thematic_on()` and/or `auto_config_set()` if auto-theming fails to do what you expect.
