...
### Problem: web technologies are not designed for data analysis, but interaction augments _exploration_!

### Solution: better bridges (e.g. shiny, plotly, ggvis, rbokeh, etc)
