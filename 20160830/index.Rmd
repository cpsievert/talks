...
* __What is plotly?__
    * R package builds on [plotly.js](https://github.com/plotly/plotly.js) (open-source JavaScript graphing library).
    * Plotly has other interfaces to plotly.js (Python, Julia, MATLAB, Ruby).
    * Share, collaborate, & edit (public: free, private: costs)
